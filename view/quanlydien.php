<link rel="stylesheet" href="../assets/css/quanlykhachhang.css">
    ...
    if (isset($data)) {
        if ($data && !empty($data)) {
            ...
            if ($totalPages > 1) {
                ...
                <div>';
                if ($currentPage > 1) {
                    echo '<a href="?act=quanlydien&p=' . ($currentPage - 1) . '&size=' . $listsPerPage . '">&lt;</a>';
                }
                ...
                for ($i = $start; $i <= $end; $i++) {
                    if ($i == $currentPage) {
                        ...
                        echo '<a href="?act=quanlydien&p=' . $i . '&size=' . $listsPerPage . '">' . $i . '</a>';
                    }
                }

        ...
        case "themgiadien":
            ...
            if (isset($_POST['submit'])) {
                ...
                if (isset($_SESSION['error_messages']) && !empty($_SESSION['error_messages'])) {
                    echo '<p style="color: red; font-weight:font-size:20px; bold; position:relative; top:500px; left:380px ;margin:0 ;width:500px">';
                ...
                if (isset($_SESSION['success_messager']) && !empty($_SESSION['success_messager'])) {
                    echo '<div style="color: green; font-size:20px; font-weight: bold; position:relative; top:450px; left:380px ;margin:0 ;width:500px">';
